/// <summary>
/// 특수 상태 최상위 추상 베이스.
/// 제약 선언만 담당하며, 실제 제약 적용은 LeeMonsterFSM.CurrentConstraints를 통해
/// LeeMonsterBase에서 중앙 처리한다.
/// </summary>
public abstract class LeeSpecialStateBase : ILeeMonsterState
{
    public abstract SpecialStateConstraint Constraints { get; }

    public abstract void Enter (LeeMonsterContext ctx);
    public abstract void Update(LeeMonsterContext ctx);
    public abstract void Exit  (LeeMonsterContext ctx);
}
...
public abstract class UnInterruptibleState<TData> : LeeSpecialStateBase
...
public abstract class MovementLockedState<TData> : LeeSpecialStateBase
    where TData : SpecialStateDataBase
{
...
public abstract class FullLockState<TData> : LeeSpecialStateBase
    where TData : SpecialStateDataBase
{
