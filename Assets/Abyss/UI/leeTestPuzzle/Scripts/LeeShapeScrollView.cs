...
///   └── ShapeHost    ← LeeBoardManager.shapeHost 와 동일한 오브젝트
///
/// [Inspector 설정]
///   - content          : LeeBoardManager.shapeHost 와 동일한 RectTransform 할당
///   - verticalScrollbar: 직접 할당하거나 null 이면 ShapeScrollView 오른쪽에 자동 생성
/// </summary>
[DisallowMultipleComponent]
[RequireComponent(typeof(ScrollRect))]
[RequireComponent(typeof(RectMask2D))]
public class LeeShapeScrollView : MonoBehaviour
{
    [Tooltip("LeeBoardManager.shapeHost 와 동일한 RectTransform.")]
    ...
    void Awake()
    {
        if (content == null)
        {
            Debug.LogError("[LeeShapeScrollView] content가 null입니다. Inspector에서 shapeHost를 할당하세요.");
            return;
        }
