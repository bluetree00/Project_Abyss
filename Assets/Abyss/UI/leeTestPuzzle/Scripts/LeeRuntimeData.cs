...
/// <summary>
/// 런타임에 SO 없이 Lee 퍼즐 데이터를 전달하기 위한 순수 C# 데이터 클래스들.
/// LeeBoardManager.SetRuntimeData(data) 또는 EnterGrid(data)에 넘겨 사용한다.
/// </summary>

[Serializable]
public class LeeGridPatternData
{
    public int rows = 8;
...
[Serializable]
public class LeeGridVisualData
{
...
public class LeeGridAssetData
{
    ...
    public LeeGridPatternData pattern = new LeeGridPatternData();
    public LeeGridVisualData  visual  = new LeeGridVisualData();
    public LeeShapeData[]     spawnableShapes;
...
[Serializable]
public class LeeBoardConfigData
{
...
[Serializable]
public class LeePlacementRulesData
{
