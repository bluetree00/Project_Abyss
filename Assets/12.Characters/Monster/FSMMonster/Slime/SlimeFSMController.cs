...
public class SlimeFSMController : MonsterController, IMonsterStateChanger
{
    ...
    {
    RegisterState(MonsterState.Idle, new SlimeIdleState());
    RegisterState(MonsterState.Patrol, new SlimePatrolState());
    RegisterState(MonsterState.Chase, new SlimeChaseState());
    RegisterState(MonsterState.Attack, new SlimeAttackState());
    RegisterState(MonsterState.AttackReady, new SlimeAttackReadyState());
    RegisterState(MonsterState.Die, new SlimeDieState());
    }
