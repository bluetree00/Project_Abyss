...
The Bundle is planned to be more than the collection of the separate assets, the plan is to later offer demos that will showcase the combination of more than one of ARTnGAME assets used together.",
            ...
            new ChangeMainViewButton("Oceanis Water system", (screen) =>
            {
                ...
                {
                    //ProductPreferenceBase.RenderGuiAndPersistInput(WelcomeScreenPreferences.ShaderModePreferenceDefinition);
                    ProductPreferenceBase.RenderURL("Oceanis 2026 with Sky Master ULTIMATE Weather", "https://www.youtube.com/playlist?list=PLJQvoQM6t9GfKtf_ePgqN1gsON-dd9lDh"
                     );
                }
            }), 
...
Sky Master ULTIMATE UPR Beta 25 (Unity 2021.3), Beta 29 (Unity 2022.3),
Beta 30 for Unity 6.0 LTS to 6.4 (RenderGraph) and HDRP Beta 18 are available 
to all Sky Master ULTIMATE asset (Standard Pipeline system) users for 
download in Google Drive on PM request. (April 2026 releases)
The Beta versions are being developed on Unity LTS versions. 
InfiniGRASS URP Beta 2.0 and Oceanis 2026 Beta are also available.
