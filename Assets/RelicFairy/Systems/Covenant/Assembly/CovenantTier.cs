/// <summary>
/// 조립 서약 티어 — 카드의 파워 등급(LoL 증강 실버/골드/프리즘 감성).
/// 티어는 "순수 파워 축"이다(조건을 어렵게 만드는 게 아니라 보상을 키움).
/// 리스크는 원인(Cause) 종류 선택 자체가 담당. 프리즘 = 최상(레어).
/// </summary>
