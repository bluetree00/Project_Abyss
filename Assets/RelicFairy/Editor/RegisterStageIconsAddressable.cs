...
/// 메뉴: RelicFairy/Stage/Register Map Icon Addressables
/// </summary>
public static class RegisterStageIconsAddressable
{
    private static readonly (string path, string address)[] Icons =
    {
        ("Assets/RelicFairy/Prefabs/UI/Bamao/BamaoUIPack/Sprites/MAP/flag_1.png",     "flag_1"),
        ("Assets/RelicFairy/Prefabs/UI/Bamao/BamaoUIPack/Sprites/MAP/dragon.png",     "dragon"),
        ("Assets/RelicFairy/Prefabs/UI/Bamao/BamaoUIPack/Sprites/MAP/sword_1.png",    "sword_1"),
        ("Assets/RelicFairy/Prefabs/UI/Bamao/BamaoUIPack/Sprites/MAP/skeleton_1.png", "skeleton_1"),
        ("Assets/RelicFairy/Prefabs/UI/Bamao/BamaoUIPack/Sprites/MAP/symbol_1.png",   "symbol_1"),
